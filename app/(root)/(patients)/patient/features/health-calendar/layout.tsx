      ...
      <header className="lg:sticky fixed top-16 sm:top-16 md:top-16 lg:top-0 z-10 w-full bg-lblue bg-opacity-20 backdrop-filter backdrop-blur-lg shadow-lg">
        <div className="container mx-auto px-4 py-2">
          <div className="flex gap-2 items-center justify-between ">
            ...
            <div className="relative lg:w-96 w-full md:w-96 sm:w-96 bg-background p-2 rounded-md">
              <button
                className="w-full text-xl font-bold tracking-tight px-3 py-1 rounded-md hover:border-2 transition-colors duration-500 ease-in-out text-white hover:text-blue hover:bg-white bg-blue"
